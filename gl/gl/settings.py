...
SECRET_KEY = "django-insecure--^(e=+5iu5-z-v$@qvv86fb=ho2unfz+0$ek5-l#7cpwxleigt"
...
WSGI_APPLICATION = "gl.gl.wsgi.application"
...
LOGIN_REDIRECT_URL = '/'  # Rediriger vers la page d'accueil après connexion
