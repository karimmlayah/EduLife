# Generated by Django 5.2.7 on 2025-11-05 04:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('face_id_enabled', models.BooleanField(default=False, verbose_name='Face ID activé')),
                ('face_id_credential_id', models.TextField(blank=True, null=True, verbose_name='ID du credential Face ID')),
                ('face_id_public_key', models.TextField(blank=True, null=True, verbose_name='Clé publique Face ID')),
