...
urlpatterns = [
    ...
    path('comment/<int:comment_id>/update/', views.update_comment_view, name='update_comment'),
    ...
    path('face-id/register/', views.face_id_register_page, name='face_id_register_page'),
    ...
    # Anciennes URLs (conservées pour compatibilité)
    path('auth/google/login/', views.google_auth_login, name='google_auth_login'),
