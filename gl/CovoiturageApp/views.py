...
def covoiturage_home(request):
    from gl.ReservationApp.models import Reservation, Avis
...
def offre_create(request):
    if request.method == 'POST':
        try:
            ...
            # Utiliser l'utilisateur statique configuré dans settings
            static_user = get_static_user()
            
            offre = Offre.objects.create(
                conducteur=static_user,  # Utilise l'utilisateur statique
                depart=depart,
