...
class LogementForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'model_3d': forms.URLInput(attrs={
                'class': 'form-control',
                'placeholder': 'https://username.shapespark.com/scene-name/ ou https://sketchfab.com/models/...'
            }),
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Rendre le champ video optionnel
        self.fields['video'].required = False
        # Rendre les champs latitude/longitude optionnels
